...
def main():
    ...
    parser.add_argument('--model_id', type=str, required=False,    default =  'test4', help='model id for saving')
    ...
    parser.add_argument('--data_path', type=str,    default =  'df.csv', help='data file')
    parser.add_argument('--target', type=str,    default =  'Close', help='optional target station for non-graph models')
    ...
    # forecasting task
    parser.add_argument('--features', type=str,    default =  'S', help='forecasting task, options:[M, S]; M:multivariate input, S:univariate input')
    parser.add_argument('--seq_len', type=int,    default =  5, help='input sequence length')
    parser.add_argument('--label_len', type=int,    default =  1, help='start token length. Note that Graph models only use label_len and pred_len')
    parser.add_argument('--pred_len', type=int,    default =  1, help='prediction sequence length')
    parser.add_argument('--enc_in', type=int,    default =  1, help='Number of encoder input features')
    parser.add_argument('--dec_in', type=int,    default =  1, help='Number of decoder input features')
    ...
    parser.add_argument('--e_layers', type=int,    default =  4, help='number of encoder layers for non-spatial and number of LSTM or MLP layers for GraphLSTM and GraphMLP')
    ...
    parser.add_argument('--train_strat_lstm', type=str,    default =  'mixed_teacher_forcing', help='The training strategy to use for the LSTM model. recursive or mixed_teacher_forcing')
